...
#define SCRERRORMARG 100

static bool InScreen(const vec2<>& in)
{
    return (in.x > -SCRERRORMARG) && (in.y > -SCRERRORMARG) && in.x < (SCRWIDTH + SCRERRORMARG) && in.y < (SCRHEIGHT + SCRERRORMARG);
}
}; // namespace PP2
